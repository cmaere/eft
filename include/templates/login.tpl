		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-7 col-sm-6">
					<div class="slogan" >
						<h2 class="wow fadeInRight" data-wow-delay="0.6s" data-wow-duration="0.5s">EFT SMS</h2>
						<h3 class="wow fadeInLeft" data-wow-delay="0.9s" data-wow-duration="0.5s">Electronic Funds Transfer SMS</h3>
