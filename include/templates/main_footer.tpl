		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 service"> <i class="icon-screen-desktop"></i>
					<h4>EFT Demo Tutorial</h4>
					<p>For tutorial walk through on how to use EFT SMS<a href="https://drive.google.com/file/d/0B-myFvx6NCRWaWJLcHNTU2dDQlE/edit?usp=sharing">click this here</a> </p>
				</div>
